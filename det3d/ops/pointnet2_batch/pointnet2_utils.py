...
def three_interpolate_warp(new_coords, coords, features, batch_size, **kwargs):
    """
    new_coords: (M1+M2+..., 4)
    coords: (N1+N2+..., 4) 
    features: (N1+N2+..., c)
    ...
    for i in range(batch_size):
        ...
        # get features
        # (B=1, N_i, C) -> (B=1, C, N_i)
        # print('==> in three_interpolate_warp, i: %d' %i)
        # print("==> bs_mask.shape: ", bs_mask.shape)
        # print("==> coords.shape: ", coords.shape)
        # print("==> features.shape: ", features.shape)
        # print("==> bs_mask.float().sum(): ", bs_mask.float().sum())
        # print("==> cur_xyz.shape: ", cur_xyz.shape)
