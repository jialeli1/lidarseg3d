...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("cube_query_wrapper", &cube_query_wrapper_stack, "cube_query_wrapper_stack");
    m.def("ball_query_with_count_wrapper", &ball_query_with_count_wrapper_stack, "ball_query_with_count_wrapper_stack");
