...
try:
    ...
    # lijiale newly adds the torch.nn.SyncBatchNorm here.
    bn_types = (nn.BatchNorm1d, nn.BatchNorm2d, nn.BatchNorm3d, nn.modules.batchnorm._BatchNorm, nn.SyncBatchNorm, SyncBatchNorm)
except:
    print('no apex')
