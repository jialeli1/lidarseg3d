    ...
    def _log_info(self, log_dict, trainer):
        if trainer.mode == "train":
            ...
            if "time" in log_dict.keys():
                ...
                log_str += "time: {:.3f}, data_time: {:.3f}, transfer_time: {:.3f}, forward_time: {:.3f}, loss_parse_time: {:.3f}, backward_time: {:.3f} ".format(
                    log_dict["time"],
                    log_dict["data_time"],
        ...
        if trainer.world_size > 1:
            try:
                ...
                class_names = trainer.model.module.point_head.tasks
        else:
            try:
                class_names = trainer.model.bbox_head.class_names
            except:
                class_names = trainer.model.point_head.tasks
