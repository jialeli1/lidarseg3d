...
from det3d.ops.mmseg_ops import ResLayer
...
class ResNet(BaseModule):
    ...
    def load_pretrained_model(self):
        ...
        print("==> Loading pretrained weights for ResNet from {}".format(filename))
        ...
        for key, val in self.state_dict().items():
            ...
            if key in state_dict:
                ...
                print("==> No matched parameters for ResNet.{}".format_map(key))
            
            if val.shape == matched_val.shape:
                update_model_state[key] = matched_val
            else:
                print("==> Shape mismatch for matched ResNet.{}".format_map(key))
    ...
    def _freeze_stages(self):
        ...
        for i in range(1, self.frozen_stages + 1):
            ...
            for param in m.parameters():
                param.requires_grad = False
            print("==> stage {} frozen for ResNet".format(i))
