...
class UNetCylinder3D(nn.Module):
    """
    Cylinder3D backbone
    """
    def __init__(self, num_input_features=128, name="UNetCylinder3D", voxel_size=[], point_cloud_range=[], model_cfg={},  **kwargs):
        super().__init__()
    ...
    def forward(self, batch_dict):
        ...
        batch_dict['conv_point_coords'] = torch.cat((up0e.indices[:, 0:1].float(), point_coords), dim=1)
