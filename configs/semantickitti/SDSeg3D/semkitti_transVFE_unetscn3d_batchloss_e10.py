...
model = dict(
    ...
    reader=dict(
        ...
        num_input_features=4, # for SemanticKITTI
...
data = dict(
    samples_per_gpu=4, # batchsize = num_gpus * samples_per_gpu
    workers_per_gpu=6, 
    train=dict(
        type=dataset_type,
        root_path=data_root,
...
# please increase 8 if more than 8 GPUs are used. 
device_ids = range(8)
